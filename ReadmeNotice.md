...
* ChromaDB stores the vector database in the `database/chroma` directory.

* Groq GPT OSS powers conversational responses.

* Groq Whisper API handles speech-to-text processing.

* Original DOCX templates remain unchanged and are used for document downloads.

* Temporary audio files are deleted after transcription.

## Future Enhancements

* Multi-document retrieval in a single query.

* Additional Indian legal document templates.

* More regional language support.

* OCR support for uploaded legal documents.

* PDF export for generated documents.

* Advanced legal document recommendations.
